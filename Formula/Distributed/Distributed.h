...
public:
  Distributed(vector<int> modality, int power, shared_ptr<Formula> subformula);
  ~Distributed();
  ...
  static shared_ptr<Formula> create(vector<int> modality, int power,
                                    const shared_ptr<Formula> &subformula);
  static shared_ptr<Formula> create(vector<vector<int>> modality,
                                    const shared_ptr<Formula> &subformula);
